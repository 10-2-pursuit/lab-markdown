...
* Source [https://en.wikipedia.org/wiki/Raccoon](https://en.wikipedia.org/wiki/Raccoon)
...
```
js
console.log("I have a friend that looks like a racoon under a piece of wood in the morning")
