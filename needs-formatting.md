...
The Link above is a picture of the marvelous animal that is the Racoon.These amazing creatures are at times referred to as  "coons" for short.
...
```javascript
console.log("Racoons are oftenly misunderstood animals. However if we view them through a scientific lense, they become so much more interesting")
```
