...
![Close up of Raccoon](https://curiodyssey.org/wp-content/uploads/bb-plugin/cache/Mammals-Raccoon-square.jpg)
...
```js
console.log("Racacoonie is a Raccoon that controls a chef.")
 ```