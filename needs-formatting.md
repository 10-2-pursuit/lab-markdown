...
![puppy-eyed raccoon](https://curiodyssey.org/wp-content/uploads/bb-plugin/cache/Mammals-Raccoon-square.jpg)
...
```js
console.log("Can be very vicious when threatened and known to go through trash for food")
```